...
<link href="{{asset('css/artists.css')}}" rel="stylesheet" type="text/css"/>
</head>
<body>
                    ...
                    @foreach ( $artists as $artist )
						...
						<div class="artist artist{{ $count }}">
							<div class="row">
								...
								<!-- Artist Image -->
								<div class="col-lg-6">
									<div class="artist_image"><a href="/artist_{{ $artist }}"><img src="images/artists/{{ $artist }}.jpg" alt=""></a></div>
								</div>
								...
								<div class="col-lg-6 artist_col">
									<div class="artist_content">
										<div class="artist_info">
											<div class="artist_name"><h1><a href="/artist_{{ $artist }}">{{ $artist }}</a></h1></div>
										...
										<div class="single_player_container">
											<div class="single_player">
												<div class="jp-jplayer jplayer" data-title="{{ $songs[$count-1] }}" data-artist="{{ $artist }}" data-ancestor=".jp_container_{{ $count }}" data-url="files/bensound-betterdays.mp3"></div>
...
<script src="{{ asset('js/main-artists.js') }}"></script>
</body>
</html>