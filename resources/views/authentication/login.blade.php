	...
	<div class="contact">
		<div class="container">
			<div class="row">
				...
				<!-- Contact Form -->
				<div class="col-lg-6x offset-lg-1 contact_col centre-sec">
				    <div class="contact_content">
						<div class="contact_title">Log in</div>
					</div>
					</br></br>
					<div class="contact_form_container">
						<form action="{{ route('loguser') }}" class="contact_form" id="contact_form" method="post">
						    @csrf <!-- {{ csrf_field() }} -->
							...
							<div>
							    <input id="password" type="password" class="contact_input @error('password') is-invalid @enderror" placeholder="Password" name="password" required autocomplete="current-password">
								@error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
