...
<div class="super_container">
				...
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_title">Album</div>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="artist" data-album="{{ $album }}">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 order-lg-2 order-1">
					<div class="artist_info">
						...
						<div class="artist_title">by <a id="art" href="/artist_{{ $artist }}">{{ $artist }}</a></div>
						<div class="artist_info_list">
							<ul>
								<li>Release: <span></span></li>
							</ul>
						</div>
			    ...
			    <div class="songs_container">
				        <div class="col-lg-4">
				            <div class="songs_content">
						        <div class="songs_title"><h1>Songs</h1></div>
						...
						<div class="song">
							...
							<div class="single_player_container">
								<div class="single_player">
									<div id="song{{ $count }}" class="jp-jplayer jplayer" data-title="{{ $song }}" data-artist="{{ $name }}" data-ancestor=".jp_container_{{ $count }}" data-url="files/bensound-betterdays.mp3"></div>
...
<script src="{{ asset('js/main-album.js') }}"></script>
</body>
</html>